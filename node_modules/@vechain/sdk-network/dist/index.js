...
var ProviderInternalHDWallet = class extends ProviderInternalBaseWallet {
   ...
   */
  constructor(mnemonic, count = 1, initialIndex = 0, derivationPath = import_sdk_core21.VET_DERIVATION_PATH, options) {
    super(
      [...Array(count).keys()].map((path) => {
        const privateKeyBuffer = import_sdk_core21.HDNode.fromMnemonic(
          mnemonic,
          derivationPath
  ...
  try {
    ...
    throw new import_sdk_errors36.JSONRPCInternalError(
      ...
      'Method "eth_sendTransaction" failed.',
      {
        ...
        url: thorClient.httpClient.baseURL,
        innerError: (0, import_sdk_errors36.stringifyData)(e)
      }
    );
  }
};
...
var ethSubscribe = async (thorClient, params, provider) => {
  ...
  if (provider.getPollInstance() === void 0) {
    ...
    if (block !== void 0 && block !== null) {
      ...
      throw new import_sdk_errors38.JSONRPCServerError(
        "ethSubscribe()",
        -32e3,
  ...
  const subscriptionId = import_sdk_core34.Hex.random(16).digits;
...
var debugTraceTransaction = async (thorClient, params) => {
  ...
  if (!import_sdk_core35.ThorId.isValid(transactionId)) {
    throw new import_sdk_errors40.InvalidDataType(
      "debug_traceTransaction()",
      "Invalid transaction ID given as input. Input must be an hex string of length 64.",
      { transactionId }
    );
...
var ethCoinbase = async (thorClient, params) => {
  ...
  throw new import_sdk_errors43.FunctionNotImplemented(
    "eth_coinbase",
...
var ethFeeHistory = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors44.FunctionNotImplemented(
    "eth_feeHistory",
...
var ethGetBlockTransactionCountByHash = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors45.FunctionNotImplemented(
...
var ethGetBlockTransactionCountByNumber = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors46.FunctionNotImplemented(
...
var ethGetTransactionByBlockHashAndIndex = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors47.FunctionNotImplemented(
...
var ethGetTransactionByBlockNumberAndIndex = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors48.FunctionNotImplemented(
...
var ethGetUncleByBlockHashAndIndex = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors49.FunctionNotImplemented(
...
var ethGetUncleByBlockNumberAndIndex = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors50.FunctionNotImplemented(
...
var ethGetUncleCountByBlockHash = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors51.FunctionNotImplemented(
...
var ethGetUncleCountByBlockNumber = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors52.FunctionNotImplemented(
...
var ethGetWork = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors53.FunctionNotImplemented(
    "eth_getWork",
...
var ethMining = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors54.FunctionNotImplemented(
    "eth_mining",
...
var ethHashrate = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors55.FunctionNotImplemented(
    "ethHashrate",
...
var ethProtocolVersion = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors56.FunctionNotImplemented(
    "eth_protocolVersion",
...
var ethSign = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors57.FunctionNotImplemented(
    "eth_sign",
...
var ethSubmitWork = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors58.FunctionNotImplemented(
    "eth_submitWork",
...
var netListening = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors59.FunctionNotImplemented(
    "net_listening",
...
var netPeerCount = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors60.FunctionNotImplemented(
    "net_peerCount",
...
var parityNextNonce = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors61.FunctionNotImplemented(
    "parity_nextNonce",
...
var ethNewFilter = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors62.FunctionNotImplemented(
    "eth_newFilter",
...
var ethNewBlockFilter = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors63.FunctionNotImplemented(
    "eth_newBlockFilter",
...
var ethNewPendingTransactionFilter = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors64.FunctionNotImplemented(
...
var ethGetFilterLogs = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors65.FunctionNotImplemented(
    "eth_getFilterLogs",
...
var ethGetFilterChanges = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors66.FunctionNotImplemented(
...
var ethUninstallFilter = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors67.FunctionNotImplemented(
    "eth_uninstallFilter",
...
var debugGetBadBlocks = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors68.FunctionNotImplemented(
    "debug_getBadBlocks",
...
var debugGetRawBlock = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors69.FunctionNotImplemented(
    "debug_getRawBlock",
...
var debugGetRawHeader = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors70.FunctionNotImplemented(
    "debug_getRawHeader",
...
var debugGetRawReceipts = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors71.FunctionNotImplemented(
...
var debugGetRawTransaction = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors72.FunctionNotImplemented(
...
var engineExchangeCapabilities = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors73.FunctionNotImplemented(
...
var engineExchangeTransitionConfigurationV1 = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors74.FunctionNotImplemented(
...
var engineForkchoiceUpdatedV1 = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors75.FunctionNotImplemented(
...
var engineForkchoiceUpdatedV2 = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors76.FunctionNotImplemented(
...
var engineForkchoiceUpdatedV3 = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors77.FunctionNotImplemented(
...
var engineGetPayloadBodiesByHashV1 = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors78.FunctionNotImplemented(
...
var engineGetPayloadBodiesByRangeV1 = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors79.FunctionNotImplemented(
...
var engineGetPayloadV1 = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors80.FunctionNotImplemented(
    "engine_getPayloadV1",
...
var engineGetPayloadV2 = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors81.FunctionNotImplemented(
    "engine_getPayloadV2",
...
var engineGetPayloadV3 = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors82.FunctionNotImplemented(
    "engine_getPayloadV3",
...
var engineNewPayloadV1 = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors83.FunctionNotImplemented(
    "engine_newPayloadV1",
...
var engineNewPayloadV2 = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors84.FunctionNotImplemented(
    "engine_newPayloadV2",
...
var engineNewPayloadV3 = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors85.FunctionNotImplemented(
    "engine_newPayloadV3",
...
var ethCreateAccessList = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors86.FunctionNotImplemented(
...
var ethGetBlockReceipts = async (thorClient, params) => {
  if (params.length !== 1 || typeof params[0] !== "string")
    throw new import_sdk_errors87.JSONRPCInvalidParams(
  ...
  try {
    ...
    throw new import_sdk_errors87.JSONRPCInternalError(
      "ethGetBlockReceipts()",
      -32603,
      'Method "ethGetBlockReceipts" failed.',
      {
        params: (0, import_sdk_errors87.stringifyData)(params),
        url: thorClient.httpClient.baseURL,
        innerError: (0, import_sdk_errors87.stringifyData)(e)
      }
    );
  }
};
...
var ethGetProof = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors88.FunctionNotImplemented(
    "eth_getProof",
...
var ethMaxPriorityFeePerGas = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors89.FunctionNotImplemented(
...
var ethSignTransaction = async (thorClient, params) => {
  await Promise.resolve(0);
  throw new import_sdk_errors90.FunctionNotImplemented(
    "eth_signTransaction",
...
var VeChainProvider = class extends import_events2.EventEmitter {
  ...
  constructor(thorClient, wallet, enableDelegation = false) {
    ...
    if (enableDelegation && wallet?.delegator === void 0) {
      throw new import_sdk_errors91.JSONRPCInvalidParams(
  ...
  async request(args) {
    if (!Object.values(RPC_METHODS).map((key) => key.toString()).includes(args.method)) {
      throw new import_sdk_errors91.JSONRPCMethodNotFound(
  ...
  async getLogsRPC() {
    const promises = Array.from(
      ...
      const currentBlock = import_sdk_core36.HexInt.of(
        this.subscriptionManager.currentBlockNumber
      ).toString();
      const filterOptions = {
    ...
    try {
      if (this.debug) {
        ...
        (0, import_sdk_logging.VeChainSDKLogger)("log").log({
          ...
          messages: [
            `params: ${(0, import_sdk_errors92.stringifyData)(args.params)}`,
            `accounts: ${(0, import_sdk_errors92.stringifyData)(accounts)}`,
            `delegator: ${(0, import_sdk_errors92.stringifyData)(delegator)}`,
      ...
      if (this.debug) {
        (0, import_sdk_logging.VeChainSDKLogger)("log").log({
          ...
          messages: [`result: ${(0, import_sdk_errors92.stringifyData)(result)}`]
        });
      }
      return result;
    } catch (e) {
      if (this.debug) {
        (0, import_sdk_logging.VeChainSDKLogger)("error").log(
          new import_sdk_errors92.JSONRPCInternalError(
            args.method,
            -32603,
