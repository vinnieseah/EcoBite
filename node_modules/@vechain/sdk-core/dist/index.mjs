...
// src/vcdm/Address.ts
import {
  InvalidDataType as InvalidDataType7,
  InvalidHDNode as InvalidHDNode2,
...
function bigNumberOf(value) {
  ...
  if (bn.isNaN())
    throw new InvalidDataType4("unitUtils.bigNumberOf()", "Not a number.", {
...
var HexInt = class _HexInt extends Hex {
  ...
  get n() {
    ...
    throw new InvalidDataType5("HexInt.n", "not in the safe number range", {
      bi: `${bi}`,
      hex: this.toString()
    });
  }
  ...
  static of(exp) {
    try {
      ...
      if (typeof exp === "number") {
        ...
        throw new InvalidDataType5("HexInt.of", "not an integer", {
          exp
        });
      }
  ...
  static of(exp) {
    try {
      ...
      if (_Address.isValid(huint.toString())) {
        ...
        throw new InvalidDataType7("Address.of", "not a valid address", {
          huint
        });
      }
    } catch (error) {
...
import { InvalidDataType as InvalidDataType8, InvalidOperation as InvalidOperation4 } from "@vechain/sdk-errors";
var BloomFilter = class _BloomFilter {
  ...
  join(other) {
    ...
    throw new InvalidOperation4("BloomFilter.join", "different k values", {
      this: this,
      other
    });
  }
...
import {
  ...
  InvalidHDNode as InvalidHDNode3,
  InvalidHDNodeMnemonic as InvalidHDNodeMnemonic2,
  InvalidOperation as InvalidOperation5
} from "@vechain/sdk-errors";
...
var Keccak256 = class _Keccak256 extends HexUInt {
  ...
  static of(exp) {
    try {
      ...
      throw new InvalidOperation7("Keccak256.of", "hash error", {
        exp: `${exp}`,
        // Needed to serialize bigint values.
        e
      });
...
var Sha256 = class _Sha256 extends HexUInt {
  ...
  static of(exp) {
    try {
      ...
      throw new InvalidOperation8("Sha256.of", "hash error", {
        exp: `${exp}`,
        // Needed to serialize bigint values.
        e
      });
